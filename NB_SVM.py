...
# Initialize models - Naive Bayes (MultinomialNB) and Support Vector Machine (SVC with linear kernel)
models = {
    'Naive Bayes': MultinomialNB(),
    'SVM': SVC(kernel='linear', max_iter=1000, tol=1e-3, verbose=True)
}
